...
\vspace{-20pt}
\bp
\hspace{202pt}{\footnotesize\color{red!75!black} Red}\\ \vspace{-16pt}\ura\ura\ura\ura\ura\ura\ura
...
\vspace{-20pt}
\bp
\hspace{115pt}{\footnotesize\color{red!75!black} Red}\\ \vspace{-16pt}\ura\ura\ura\ura
...
\ep
\end{screen}
In this case, this opponent's wait is very likely to be in the neighborhood of the last discard, {\LARGE\suo{4}}. In particular, {\LARGE\suo{2}-\suo{5}} {\jap suji} and {\LARGE\suo{3}-\suo{6}} {\jap suji} are extremely dangerous, and a closed wait of {\LARGE\suo{7}} is also a possibility.
